...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="gradeName" value="" type="text" class="input_2 txtinput1" /></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">年级编码：</th>
        <td style="width:70%; text-align:left;"><input id="gradeCode" value="" type="text" class="input_2 txtinput1" maxlength="4"/></td>
    </tr>
    <!--  <tr align="center">
    ...
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="确认添加" onclick="addGrade()" class="input2" /></td>
    </tr>
</table>
</div>
