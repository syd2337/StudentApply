...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="subjectName" value="${subject.name}" type="text" class="input_2 txtinput1" readonly="readonly"/></td>
    </tr>
     <tr align="center">
        <th style="width:20%; text-align:left;">新名称：</th>
        <td style="width:70%; text-align:left;"><input id="newSubjectName" value="" type="text" class="input_2 txtinput1"/></td>
    </tr>
    <!-- <tr align="center">
    ...
    <td colspan="2" style="text-align:center;">
    	<input type="submit" id="btnSubmit" value="确认修改" onclick="updateSubject('${subject.id}')" class="input2" />
    </td>
    </tr>
</table>
</div>
