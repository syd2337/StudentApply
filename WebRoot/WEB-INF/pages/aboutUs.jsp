...
<body>
	<div class="main">
		...
		<div class="menu">
			...
			<li id=active><a href="aboutUs.html">关于智仁</a>
			</li>
			...
			<ul class="comm_right">
				<p>
					您当前所在位置:<a href="selectIncludeByType.html">首页</a>&gt;&gt;<a
						href="#">${aboutUs.title}</a>
				</p>
				<div id="mainbr">

					<div id="stuffbox">

						<h1 style="text-align:center;">${aboutUs.title}</h1>
						<p align="left">
							<span style="font-size:16px;color:#666666;">${aboutUs.content}</span>
						</p>
