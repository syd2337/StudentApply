...
<link href="Style/ks.css" rel="stylesheet" type="text/css" />
    ...
    function deleteCampus(campusId,name){
    	if(confirm("是否确认删除"+name)){
    	$.ajax({
		url:'deleteCampus.html',
		type:'POST',
		data:{
			'id':campusId
		},
    ...
    function selectCampus (){
    	var likeCampusName = $("#likeCampusName").val();
    	window.location.href='selectCampusLikeName.html?likeCampusName='+likeCampusName;
...
<body onload="login('${sessionScope.user.name}')">
    ...
    <div class="cztable">
        <div class="tis">
            校区名称：<input id="likeCampusName" value="${likeCampusName}"/><button onclick="selectCampus()">查询</button><a href="toAddCampus.html"><button>添加</button></a>
        </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr align="center"><td colspan="4"><c:if test="${empty campusList}">无数据请添加</c:if></td></tr>
                ...
                <tr align="center">
                    ...
                    <td>
                    <a href="toUpdateCampus.html?id=${li.id}"><button>修改</button></a><button  onclick="deleteCampus('${li.id}','${li.campusName}')">删除</button>                        
                    </td>
                </tr>
                </c:forEach>                               
            </tbody>
