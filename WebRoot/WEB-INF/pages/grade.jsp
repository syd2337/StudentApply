...
<link href="Style/ks.css" rel="stylesheet" type="text/css" />
    ...
    function deleteGrade(gradeId,name){
    	if(confirm("是否确认删除"+name)){
    	$.ajax({
		url:'deleteGrade.html',
		type:'POST',
		data:{
			'id':gradeId
		},
...
<body onload="login('${sessionScope.user.name}')">
    ...
    <div class="morebt">
        <ul>
            ...
            <li><a class="tab1" href="grade.html">年级管理</a></li>
    ...
    <div class="cztable">
        <div class="tis">
            校区名称：<input id="likeGradeName" value="${likeGradeName}"/><button onclick="selectGrade()">查询</button><a href="toAddGrade.html"><button>添加</button></a>
        </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr align="center"><td colspan="4"><c:if test="${empty gradeList}">无数据请添加</c:if></td></tr>
                ...
                <tr align="center">
                    ...
                    <td>
                    <a href="toUpdateGrade.html?id=${li.id}"><button>修改</button></a><button  onclick="deleteGrade('${li.id}','${li.name}')">删除</button>                        
                    </td>
                </tr>
                </c:forEach>                               
            </tbody>
