...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    ...
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="startTime"  value='<fmt:formatDate value="${course.startTime}" pattern="yyyy-MM-dd"/>' class="Wdate" type="text" onclick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})"/> </td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">结束时间：</th>
        <td style="width:70%; text-align:left;"><input id="endTime"  value='<fmt:formatDate value="${course.endTime}" pattern="yyyy-MM-dd"/>' class="Wdate" type="text" onclick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})"/></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">课程时长：</th>
        <td style="width:70%; text-align:left;"><input id="period" value="${course.period}" type="text" class="input_2 txtinput1"  placeholder="例如08:00-18:00"/></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">课程资费：</th>
        <td style="width:70%; text-align:left;"><input id="rates" value="${course.rates}" type="text" class="input_2 txtinput1" />/小时</td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">课程次数：</th>
        <td style="width:70%; text-align:left;"><input id="times" value="${course.times}" type="text" class="input_2 txtinput1" maxlength="4"/>次</td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">课时：</th>
        <td style="width:70%; text-align:left;"><input id="theClass" value="${course.theClass}" type="text" class="input_2 txtinput1" maxlength="4"/>课时</td>
    </tr>
    <!--  <tr align="center">
    ...
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="确认修改" onclick="updateCourse('${course.id}')" class="input2" /></td>
    </tr>
</table>
</div>
