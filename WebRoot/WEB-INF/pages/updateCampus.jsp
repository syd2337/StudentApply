...
<link href="Style/ks.css" rel="stylesheet" type="text/css" />
    ...
    function updateCampus(campusId){
    
    	
    	var id = campusId;
    	var newCampusName =$("#newCampusName").val();
    	//alert(newSchoolName+schoolId);
    	var newCampusCode = $("#newCampusCode").val();
    	if (newCampusName == '') {
				alert("校区不能为空");
    	...
    	$.ajax({
		url:'updateCampus.html',
		type:'POST',
		data:{
			'newCampusName':newCampusName,
			'newCampusCode':newCampusCode,
			'id':id,
		},
		dataType:'json',
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="campusName" value="${campus.campusName}" type="text" class="input_2 txtinput1" readonly="readonly"/></td>
    </tr>
     <tr align="center">
        <th style="width:20%; text-align:left;">新名称：</th>
        <td style="width:70%; text-align:left;"><input id="newCampusName" value="" type="text" class="input_2 txtinput1"/></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">校区编码：</th>
        <td style="width:70%; text-align:left;"><input id="campusCode" value="${campus.code}" type="text" class="input_2 txtinput1" readonly="readonly"/></td>
    </tr>
     <tr align="center">
        <th style="width:20%; text-align:left;">新编码：</th>
        <td style="width:70%; text-align:left;"><input id="newCampusCode" value="" type="text" class="input_2 txtinput1" maxlength="4"/></td>
    </tr>
    <!-- <tr align="center">
    ...
    <td colspan="2" style="text-align:center;">
    	<input type="submit" id="btnSubmit" value="确认修改" onclick="updateCampus('${campus.id}')" class="input2" />
    </td>
    </tr>
</table>
</div>
