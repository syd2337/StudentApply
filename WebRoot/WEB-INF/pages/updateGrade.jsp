...
<link href="Style/ks.css" rel="stylesheet" type="text/css" />
    ...
    function updateGrade(gradeId){
    	...
    	var newGradeCode =$("#newGradeCode").val();
		...
		if (newGradeCode == '') {
			...
			//var reg = /^[A-Z]{2}$/;
			//if (!reg.test(newGradeCode)) {
				//alert("编码为两位大写字母");
				//return;
			//}
    	$.ajax({
		url:'updateGrade.html',
		type:'POST',
		data:{
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="gradeName" value="${grade.name}" type="text" class="input_2 txtinput1" readonly="readonly"/></td>
    </tr>
     <tr align="center">
        <th style="width:20%; text-align:left;">新名称：</th>
        <td style="width:70%; text-align:left;"><input id="newGradeName" value="" type="text" class="input_2 txtinput1"/></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">年级编码：</th>
        <td style="width:70%; text-align:left;"><input id="gradeCode" value="${grade.code}" type="text" class="input_2 txtinput1" readonly="readonly"/></td>
    </tr>
     <tr align="center">
        <th style="width:20%; text-align:left;">新编码：</th>
        <td style="width:70%; text-align:left;"><input id="newGradeCode" value="" type="text" class="input_2 txtinput1"/></td>
    </tr>
    <!-- <tr align="center">
    ...
    <td colspan="2" style="text-align:center;">
    	<input type="submit" id="btnSubmit" value="确认修改" onclick="updateGrade('${grade.id}')" class="input2" />
    </td>
    </tr>
</table>
</div>
