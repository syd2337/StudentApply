...
<link rel="stylesheet" href="Style/parts.css" type="text/css">
<body>
	<div class="main">
		<div class="top"></div>
		<div class="menu">
			...
			<ul class="comm_right">
				<p>
					您当前所在位置:<a href="selectIncludeByType.html">首页</a>&gt;&gt;<a
						href="#">${include.titleType}</a>
				</p>
				<div id="mainbr">

					<div id="stuffbox">

						<h1 style="text-align:center;">${include.title}</h1>
						<p align="left">
							<pre><span style="font-size:16px;color:#666666;">${include.content}</span></pre>
						</p>
