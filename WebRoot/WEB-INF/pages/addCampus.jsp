...
<script type="text/javascript" language="javascript">
    function addCampus(){
		...
		alert(data)
			...
			if(data==null){
				alert("添加校区失败!");
				}else if(data.campusName==campusName){
				alert("该校区已存在!")
			}else{
...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="campusName" value="" type="text" class="input_2 txtinput1" /></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">校区编码：</th>
        <td style="width:70%; text-align:left;"><input id="campusCode" value="" type="text" class="input_2 txtinput1" maxlength="4"/></td>
    </tr>
    <!--  <tr align="center">
    ...
    <tr>
    <td colspan="2" style="text-align:center;"><input type="submit" id="btnSubmit" value="确认添加" onclick="addCampus()" class="input2" /></td>
    </tr>
</table>
</div>
