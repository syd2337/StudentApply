...
<body onload="login('${sessionScope.user.name}')">
    ...
    <div class="morebt">
        <ul>
        	<li><a class="tab1" href="school.html">学校管理</a></li>
    ...
    <div class="cztable">
        <div class="tis">
            学校名称：<input id="likeSchoolName" value="${likeSchoolName}"/><button onclick="selectSchool()">查询</button><a href="toAddSchool.html"><button>添加</button></a>
        </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr align="center"><td colspan="4"><c:if test="${empty schoolList}">无数据请添加</c:if></td></tr>
                ...
                <tr align="center">
                    ...
                    <td>
                    <a href="toUpdateSchool.html?id=${li.id}"><button>修改</button></a><button  onclick="deleteSchool('${li.id}','${li.name}')">删除</button>                        
                    </td>
                </tr>
                </c:forEach>                               
            </tbody>
