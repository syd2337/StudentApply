...
<table border="0" cellspacing="0" cellpadding="0" width="500px" style="margin:30px auto 0px auto;">
    <tr align="center">
        ...
        <td style="width:70%; text-align:left;"><input id="schoolName" value="${sessionScope.user.name}" type="text" class="input_2 txtinput1" readonly="readonly" /></td>
    </tr>
    <tr align="center">
        <th style="width:20%; text-align:left;">电话：</th>
        <td style="width:70%; text-align:left;"><input id="schoolName" value="${sessionScope.user.phoneNum}" type="text" class="input_2 txtinput1" readonly="readonly"/></td>
    </tr>
    <tr align="center">
