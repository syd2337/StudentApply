        ...
        <table id="ta" width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr align="center">
                    ...
                    <td>
                        <a href="selectStuCourseByStudentId.html?id=${student.id}">${student.name}</a>
                    </td>
                    <td>
                        ${student.sex}
                    </td>
                    ...
                    <td>
                    <button onclick="toUpdateStudent('${student.id}','${student.payCondition}')">修改</button><button  onclick="deleteStudent('${student.id}','${student.name}','${student.payCondition}')">删除</button>                        
                    </td>
                </tr>
